...
const MAX_OPTIONS = 100;       // Para multiple choice, checkbox, dropdown
const MAX_GRID_ROWS = 100;     // Para linhas de grade
const MAX_GRID_COLUMNS = 100;  // Para colunas de grade
