...
export default function ConfiguracoesPage() {
  ...
  const [userData, setUserData] = useState({
    name: "João Silva",
    email: "joao.silva@upe.br",
    course: "Ciência da Computação",
    campus: "Campus Garanhuns",
  ...
  const handleSave = () => {
    setIsEditing(false)
    // Aqui vai ser implementada a lógica para salvar os dados
  }
                ...
                <div className="flex flex-col md:flex-row gap-6">
                  <div className="flex flex-col items-center space-y-2">
                    <Avatar className="h-24 w-24">
                      ...
                      <AvatarFallback className="bg-upe-blue text-white text-xl">JS</AvatarFallback>
                    </Avatar>
                    <Button
                      variant="outline"
                      size="sm"
                  ...
                  <div className="flex-1 space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Select
                          disabled={!isEditing}
                          defaultValue={userData.campus}
                          onValueChange={(value) => setUserData({ ...userData, campus: value })}
                        >
                          <SelectTrigger>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input id="registration" value={userData.registration} disabled />
                      </div>
                      <div className="space-y-2">
                ...
                <div className="flex justify-end gap-2">
                  {isEditing ? (
                    <>
                      ...
                      <Button onClick={handleSave} className="bg-upe-blue hover:bg-upe-blue/90 text-white">
                        Salvar alterações
                      </Button>
                    </>
                  ) : (
                    <Button onClick={() => setIsEditing(true)} className="bg-upe-blue hover:bg-upe-blue/90 text-white">
                      Editar perfil
                    </Button>
                  )}
                </div>
